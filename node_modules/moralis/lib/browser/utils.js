...
var isSemanticVersionLarger = function (version1, version2) {
  ...
  var version1Arr = (0, _map.default)(_context6 = version1.split('.')).call(_context6, function (s) {
    return Number(s);
  });
  var version2Arr = (0, _map.default)(_context7 = version2.split('.')).call(_context7, function (s) {
    return Number(s);
  });
